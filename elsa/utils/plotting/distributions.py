...
class Distribution(Observable):
	...
	def plot(self):
		if self.latent == True:
			...
			if self.dataset == 'Drell_Yan':
			...
			elif self.dataset == '2d_gaussian_grid':
				self.gaussian_grid_distributions()
				...
				self.basic_2d_distributions()
			elif self.dataset == 'px_py':
				self.px_py_distributions()
	...
	def basic_2d_distributions(self):
		...
		args = {			 
			'x' : ([0], self.roll_0, 100, (-1.2,1.2) ,r'$x$', r'x',False),
			'y' : ([0], self.roll_1, 100, (-1.2,1.2) ,r'$y$', r'y',False),
		}	 

		args2 = {			 
			'x' : ([0], self.roll_0, 100, (-0.6,0.6) ,r'$x$', r'x',False),
			'y' : ([0], self.roll_1, 100, (-0.6,0.6) ,r'$y$', r'y',False),
		}
	 
		self.args = args
		self.args2 = args2

	def px_py_distributions(self):
		 # Particle_id, observable, bins, range, x_label, log_scale

		args = {			 
			'x' : ([0], self.roll_0, 100, (-80.2,80.2) ,r'$tau1$', r'tau1',False),
			'y' : ([0], self.roll_1, 100, (-80.2,80.2) ,r'$tau2$', r'tau2',False),
			'r' : ([0], self.ratio, 100, (-80.2,80.2) ,r'$ratio$', r'ratio',False),
		}	 

		args2 = {			 
			'x' : ([0], self.roll_0, 100, (-80.2,80.2) ,r'$x$', r'x',False),
			'y' : ([0], self.roll_1, 100, (-80.2,80.2) ,r'$y$', r'y',False),
		}
	...
	def eight_gauss_distributions(self):
		...
		args = {			 
			'x' : ([0], self.roll_0, 200, (-4.1,4.1) ,r'$x$', r'x',False),
			'y' : ([0], self.roll_1, 200, (-4.1,4.1) ,r'$y$', r'y',False),
		}	 
	...
	def gaussian_grid_distributions(self):
		 # Particle_id, observable, bins, range, x_label, log_scale

		args = {			 
			'x' : ([0], self.roll_0, 100, (-24.2,24.2) ,r'$x$', r'x',False),
			'y' : ([0], self.roll_1, 100, (-24.2,24.2) ,r'$y$', r'y',False),
		}	 

		args2 = {			 
			'x' : ([0], self.roll_0, 200, (-24.2,24.2) ,r'$x$', r'x',False),
			'y' : ([0], self.roll_1, 200, (-24.2,24.2) ,r'$y$', r'y',False),
		}
