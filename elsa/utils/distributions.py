...
class Distribution(Observable):
	...
	def w_2jets_distributions(self):
		...
		args = {			 
			...
			#---------------------#	
			'logdRjj' : ([1,2], self.log_delta_R, 40, (-3,3) ,r'$\log\Delta R_{\mathrm{j}\mathrm{j}}$', r'\log\Delta R_{\mathrm{j}\mathrm{j}}',False),
			'etaj1'   : ([1], self.pseudo_rapidity, 40, (-7,7) ,r'$\eta_{\mathrm{j}_1}$', r'\eta_{\mathrm{j}_1}',True),
   			'cetaj1'   : ([1], self.pseudo_rapidity_cut, 40, (-3,3) ,r'$\eta_{\mathrm{j}_1}$', r'\eta_{\mathrm{j}_1}',False),
		}	 
	...
	def latent_distributions(self):
		...
		args2 = {			 
			'z0' : ([0], self.coord_0, 200, (-3,3) ,r'$z_0$', r'$z_0$',False),
			'z1' : ([0], self.coord_1, 200, (-3,3) ,r'$z_1$', r'$z_1$',False),
			#'z2' : ([0], self.coord_2, 200, (-4,4) ,r'$z_2$', r'z_2',False),
			#'z3' : ([0], self.coord_3, 200, (-4,4) ,r'$z_3$', r'z_3',False),
			#'z4' : ([0], self.coord_4, 200, (-4,4) ,r'$z_4$', r'z_4',False),
			#'z5' : ([0], self.coord_5, 120, (-4,4) ,r'$z_5$', r'z_5',False),
			#'z6' : ([0], self.coord_6, 120, (-4,4) ,r'$z_6$', r'z_6',False),
			#'z7' : ([0], self.coord_7, 120, (-4,4) ,r'$z_7$', r'z_7',False),
			#'z8' : ([0], self.coord_8, 120, (-4,4) ,r'$z_8$', r'z_8',False),
			#'z9' : ([0], self.coord_9, 120, (-4,4) ,r'$z_9$', r'z_9',False),
